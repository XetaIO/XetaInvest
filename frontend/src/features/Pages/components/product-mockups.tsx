    ...
    return (
        ...
        >
            <div className="flex h-9 items-center gap-1.5 border-b border-white/8 px-4">
                ...
                <span className="font-mono ml-auto text-[9px] tracking-[0.2em] text-white/25">
                    XETAINVEST
                </span>
            </div>
            {children}
            ...
            <div className="p-5 sm:p-7">
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                    {[
                        ...
                        >
                            ...
                            <p className="font-mono mt-4 text-sm text-white">
                                {symbol}
                            </p>
                ...
                <div className="mt-5 rounded-lg border border-white/8">
                    {[
                        ...
                        <div
                            key={row.join('-')}
                            className="font-mono grid grid-cols-4 gap-3 border-b border-white/6 px-4 py-3 text-[10px] last:border-0"
                        >
                ...
                <div className="border-b border-white/8 p-5 lg:border-r lg:border-b-0">
                    <div className="mb-4 flex items-center justify-between">
                        <div>
                            ...
                            <p className="font-mono mt-1 text-sm text-white">
                                ^NDX · NASDAQ 100
                            </p>
                        </div>
    ...
    return (
        <MockupFrame>
            <div className="grid gap-4 p-5 sm:p-7 lg:grid-cols-[1.15fr_.85fr]">
                <div className="font-mono rounded-lg border border-white/8 bg-black/30 p-5 text-[10px]">
                    ...
                    {[
                        ...
                        [
                            '$ cargo loco start',
                            t('landing.mockup.server_active'),
                        ],
                    ].map(([command, result]) => (
