...
export function AddInvestmentDialog({ open, onOpenChange, portfolioId }: Props) {
    ...
    useEffect(() => {
        ...
        const t = setTimeout(async () => {
            try {
                ...
                const items: SearchResult[] = Array.isArray(json) ? json : (json.results ?? json.data ?? []);
                setResults(items);
            } catch (err) {
    ...
    const addLine = () => form.setData('lines', [...form.data.lines, emptyLine()]);
                                ...
                                <div key={i} className="grid grid-cols-1 gap-2 rounded-md border p-3 md:grid-cols-12">
                                    ...
                                    <div className="md:col-span-3">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => updateLine(i, 'executed_at', e.target.value)}
