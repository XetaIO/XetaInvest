...
function ChartTooltipContent({
    ...
    active?: boolean;
    payload?: Array<Record<string, unknown> & { value?: number; name?: string; dataKey?: string; color?: string; payload?: Record<string, unknown> }>;
    label?: unknown;
...
function ChartLegendContent({
    ...
    payload?: Array<Record<string, unknown> & { value?: string; dataKey?: string; color?: string }>;
            ...
            {payload.map((item) => {
                ...
                return (
                    ...
                    >
                        ...
                        {itemConfig?.label ? itemConfig.label.toString().slice(0, 20) : null}
                    </div>
                );
            })}
        </div>
