...
import type { SymbolProps } from '@/types/symbol';
            ...
            {definition ? (
                <Tooltip>
                    <TooltipTrigger asChild>
                        <span className="cursor-help text-xs text-muted-foreground underline decoration-muted-foreground/40 decoration-dotted underline-offset-2">
                            {label}
                        </span>
                    </TooltipTrigger>
...
export default function SymbolPage({
    ...
    setLayoutProps({
        breadcrumbs: [
            { title: quote?.name ?? symbol, href: `/symbol/${symbol}` },
        ],
    });
        ...
        <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {quote?.industry && (
                        <Badge variant="outline">{quote.industry}</Badge>
                    )}
                    {quote?.market_state && (
                        <Badge
                            variant={
                    ...
                    {quote ? (
                        <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2">
                            <div>
                                ...
                                {sr(
                                    'stat_prev_close',
                                    formatPrice(quote.previous_close, currency),
                                )}
                                {sr(
                                    'stat_day_high',
                            ...
                            <div>
                                ...
                                {sr(
                                    'stat_all_time_high',
                                    formatPrice(quote.all_time_high, currency),
                                )}
                            </div>
                        </div>
                    ) : (
                    ...
                    <StatsCard title={t('symbol.valuation_section')}>
                        <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                {sr(
                                    'stat_ev_revenue',
                                    formatRatio(quote.enterprise_to_revenue),
                                )}
                                {sr(
                                    'stat_ev_ebitda',
                        ...
                        <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2">
                            ...
                            <div>
                                {sr(
                                    ...
                                    toneMargin(quote.gross_margins, 0.4, 0.2),
                                )}
                                {sr(
                                ...
                                {sr(
                                    ...
                                    toneMargin(quote.profit_margins, 0.1, 0),
                                )}
                                {sr(
                                    'stat_ebitda_margins',
                                    formatPct(quote.ebitda_margins),
                                    toneMargin(quote.ebitda_margins, 0.2, 0.05),
                                )}
                                ...
                                {sr(
                                    ...
                                    toneMargin(quote.return_on_assets, 0.1, 0),
                                )}
                                {sr(
                                    'stat_roe',
                                    formatPct(quote.return_on_equity),
                                    toneMargin(quote.return_on_equity, 0.15, 0),
                                )}
                            </div>
                        </div>
                    </StatsCard>
                        ...
                        <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                {sr(
                                    ...
                                    toneRatioHigher(quote.quick_ratio, 1, 0.7),
                                )}
                            </div>
                        </div>
                    </StatsCard>
                    ...
                    <StatsCard title={t('symbol.volume_section')}>
                        <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                {sr(
                                    'stat_institutions',
                                    formatPct(quote.held_percent_institutions),
                                )}
                            </div>
                        </div>
                    </StatsCard>
                        ...
                        <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2">
                            <div>
                                ...
                                {sr(
                                    ...
                                    toneRatioLower(quote.payout_ratio, 0.6, 1),
                                )}
                            </div>
                            <div>
                                {sr(
                                    ...
                                    quote.target_mean_price !== null &&
                                        quote.price !== null
                                        ? quote.target_mean_price > quote.price
                                            ? 'positive'
                                            : 'negative'
                                        : null,
                                )}
                                {sr(
                                    ...
                                    quote.target_high_price !== null &&
                                        quote.price !== null
                                        ? quote.target_high_price > quote.price
                                            ? 'positive'
                                            : 'negative'
                                        : null,
                                )}
                                {sr(
                                    ...
                                    quote.target_low_price !== null &&
                                        quote.price !== null
                                        ? quote.target_low_price > quote.price
                                            ? 'positive'
                                            : 'negative'
                                        : null,
                                )}
                                {sr(
                                    'stat_analysts',
                                    quote.number_of_analyst_opinions !== null
                                        ? String(
