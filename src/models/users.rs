...
pub const MAGIC_LINK_EXPIRATION_MIN: i64 = 5;
...
impl Model {
    ...
    /// # Errors
    ///
    /// [`ModelError::EntityAlreadyExists`] when the email is taken, or a DB /
    /// validation error.
...
impl ActiveModel {
    ...
    pub async fn create_magic_link(mut self, db: &DatabaseConnection) -> ModelResult<Model> {
        ...
        let expired = Local::now() + Duration::minutes(MAGIC_LINK_EXPIRATION_MIN);
